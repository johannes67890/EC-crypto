...
describe("EC", () => {
    ...
    it("Check if point is on curve", () => {
         ...
         */
        const x = new BN("0C6047F9441ED7D6D3045406E95C07CD85C778E4B8CEF3CA7ABAC09B95C709EE5", "hex");
        const y = new BN("1AE168FEA63DC339A3C58419466CEAEEF7F632653266D0E1236431A950CFE52A", "hex")
    ...
    it("concat Points", () => {
        expect(ec.concatPoint({x: new BN("123", "hex"), y: new BN("456", "hex")})).toEqual(new BN("123456", "hex"));
    });
